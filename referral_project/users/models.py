...
from django.db.models import (
    EmailField, ManyToManyField, ForeignKey, CASCADE, CharField, ImageField)
from django.utils.translation import ugettext_lazy as _
from model_utils.models import TimeStampedModel
from phonenumber_field.modelfields import PhoneNumberField

from referral_project.tasks.models import Task, TaskStatus
from referral_project.users.fields import ActivatedDeactivatedStatusField
from referral_project.utils.django.fields import generate_upload_to
...
class User(AbstractUser):
    ...
    identification = ImageField(
        blank=True,
        upload_to=get_user_identification_upload_to,
    )
